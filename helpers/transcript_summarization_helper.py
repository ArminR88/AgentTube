...
DEFAULT_MAX_TRANSCRIPT_TOKENS = 10_000
...
def build_prompt() -> ChatPromptTemplate:
    ...
    system_text = (
        ...
        "   Example: \"[Jane Doe] The company reported a 15% increase in quarterly revenue.\"\n\n"
        "OUTPUT FORMAT:\n"
    ...
    human_text = (
        ...
        "Transcript:\n"
        "{transcript}\n\n"
        "Summarize the above transcript according to your system instructions."
    )
